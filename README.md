...
# Loading Replays
  You can select as many files as you want to run the script (to simulate a multi round game). Replay will automatically split the rounds, but the
the files will keep accumelating. 
# About the tabs:
